...
TARGET_KERNEL_SOURCE := kernel/eebbk/sm6150
...
BOARD_EEBBK_DYNAMIC_PARTITIONS_PARTITION_LIST := system system_ext vendor product
BOARD_EEBBK_DYNAMIC_PARTITIONS_SIZE := 9122611200 # TODO: Fix hardcoded value
...
TW_DEVICE_VERSION := $(shell date -u +"%Y%m%d"-"XKTS")
